// Tier 3: Complete Model - Composition + Environment + Temporal Climate
//
// This is the COMPLETE uncertainty budget for OHD analysis
// NO source structure - composition modeled as island-wide distributions
//
// Rationale for removing source assignments:
//   1. Stevenson 2015 has NO per-sample XRF (assignments would be assumptions)
//   2. Orito and Rano Kau I are geochemically nearly identical
//   3. Within-source variation >> between-source differences
//   4. Source mixing contributed 0% variance in original 4-tier analysis
//
// Assumptions:
...
//   - Temporal climate variation +/-0.5C
//
...
//
// Purpose: Complete uncertainty budget for OHD
// Expected: ~+/-299 years (10x Stevenson's claimed +/-30 years)
...
model {
  ...
  for (i in 1:N) {
    ...
    // Note: T_K already includes temporal_climate_effect via T_eff
