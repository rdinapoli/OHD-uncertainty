// Tier 0 with Measurement Error Sensitivity: Isolate σ_meas Contribution
//
// Purpose: What fraction of the irreducible floor comes from IR-PAS measurement precision?
//
// This model uses Stevenson's EXACT parameter values with NO parameter uncertainty:
...
//
// The ONLY uncertainty source is H₂Ome measurement error (σ_meas), which is
// passed as data to allow systematic sweeps.
//
// By sweeping σ_meas from 0.03 (calibrated) down to 0.001 (physically impossible),
// we can isolate how much of the ±289 year floor is from measurement precision
// vs. rate equation coefficient uncertainty.
//
// CREATED 2025-12-04: Measurement error floor analysis
...
model {
  ...
  for (i in 1:N) {
    ...
    // Measurement model - σ_meas now from data, not hardcoded
